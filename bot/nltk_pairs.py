...
nltk_pairs = [
    ...
    [r"(.*) age ?|how old (.*)",
     ["Dude ! I'm a computer program !\n Are you seriously asking me this ?!",
      "I'm born the 8th of february 2021, Dude !\nYou should have had a look at the Git log to get it 😉"]],
    [r"what (.*) want",
     ["Make me an offer !\n I won't deny 😉"]],
    [r"(.*) why ?",
     ["It's life Dude 😉"]],
    ...
    [r"(.*) (moviestar|actor) (.*) ?",
     ["Marion Cotillard", "Guillaume Canet", "Will Smith", "Denzel Washington"]],
    [r"quit|bye",
